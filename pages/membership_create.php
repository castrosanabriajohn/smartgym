...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (!$errors) {
        $stmt = $db->prepare('INSERT INTO membership_plans (name, duration_days, price) VALUES (:name,:duration,:price)');
        $stmt->execute([':name'=>$name, ':duration'=>$duration, ':price'=>$price]);
...
?>
<div class="container">
    <h2 class="mb-4">Create Membership Plan</h2>
    <?php if ($errors): ?>
